...
CREATE TABLE IF NOT EXISTS `mydb`.`Activity` (
  ...
  INDEX `OneRecipeNActivities` (`Recipe ID` ASC),
  PRIMARY KEY (`UniqueCode`),
  INDEX `OneKittingLineNActivities` (`Kitting Line` ASC),
  INDEX `OneDeliveryDayNActivities_idx` (`Delivery Day` ASC),
  INDEX `OneProductionDayNActivities_idx` (`Production Day` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Activity_has_Staff Table` (
  ...
  INDEX `fk_Activity_has_Staff Table_Staff Table1_idx` (`Staff Table_Staff ID` ASC),
  INDEX `fk_Activity_has_Staff Table_Activity1_idx` (`Activity_UniqueCode` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Box Info` (
  ...
  PRIMARY KEY (`BoxID`),
  INDEX `fk_Box Info_Delivery Day1_idx` (`Delivery Day` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Box_has_Recipe` (
  ...
  INDEX `fk_Box Info_has_Recipe_Recipe1_idx` (`Recipe_Recipe ID` ASC),
  INDEX `fk_Box Info_has_Recipe_Box Info1_idx` (`Box Info_BoxID` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Delivery Day` (
  ...
  `Delivery day info` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Error` (
  ...
  PRIMARY KEY (`ErrorID`),
  INDEX `fk_Error_Ingredient1_idx` (`Ingredient_SKU` ASC),
  INDEX `fk_Error_Box Info1_idx` (`BoxID` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Recipe_has_Ingredient` (
  ...
  INDEX `fk_Recipe_has_Ingredient_Ingredient1_idx` (`Ingredient_SKU` ASC),
  INDEX `fk_Recipe_has_Ingredient_Recipe1_idx` (`Recipe_Recipe ID` ASC),
